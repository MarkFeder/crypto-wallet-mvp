...
export const strings = {
  ...
  validation: {
    ...
    transaction: {
      ...
      tokenInvalid: (tokens: string) => `Token must be one of: ${tokens}`,
      ...
      fromTokenInvalid: (tokens: string) => `From token must be one of: ${tokens}`,
      fromTokenRequired: 'From token is required',
      toTokenInvalid: (tokens: string) => `To token must be one of: ${tokens}`,
...
export type ServerStrings = typeof strings;
